 ...
 */
package mensch.aerger.dich.nicht.modell.Spielfelder;

import java.awt.Color;
import java.util.LinkedList;
import mensch.aerger.dich.nicht.modell.Feld;
...
import mensch.aerger.dich.nicht.modell.Spielfeld;
...
public class VierSpielerFeld extends Spielfeld {
    ...
    protected void baueAuf() {
        ...
        this.getSpieler().put(2, new Spieler(2,Color.ORANGE));
       ...
       xPos--;
        ...
        for(int i1 = 0 ; i1 <2; i1++){
            for(int i2 = 0 ; i2 <2; i2++){
                ...
                f1 = new Feld(new Position(1 + i1, 1 + i2), FeldType.VORHAUS);
                f1.setEigentuemer(Spieler);
                
                
                Figur figur = new Figur(this.getSpieler().get(Spieler), f1);
                this.getSpieler().get(Spieler).getFiguren().add(fig, figur);
                f1.belege(figur);
                fig++;
        ...
        for(int i1 = 0 ; i1 <2; i1++){
            for(int i2 = 0 ; i2 <2; i2++){
                f1 = new Feld(new Position(10 + i1, 1 + i2), FeldType.VORHAUS);
                f1.setEigentuemer(Spieler);
        ...
        for(int i1 = 0 ; i1 <2; i1++){
            for(int i2 = 0 ; i2 <2; i2++){
                f1 = new Feld(new Position(10 + i1, 10 + i2), FeldType.VORHAUS);
                f1.setEigentuemer(Spieler);
        ...
        for(int i1 = 0 ; i1 <2; i1++){
            for(int i2 = 0 ; i2 <2; i2++){
                ...
                f1 = new Feld(new Position(1 + i1, 10 + i2), FeldType.VORHAUS);
                f1.setEigentuemer(Spieler);
